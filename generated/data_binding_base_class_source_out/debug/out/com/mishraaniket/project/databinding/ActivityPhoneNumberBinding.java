...
public final class ActivityPhoneNumberBinding implements ViewBinding {
  ...
  private ActivityPhoneNumberBinding(@NonNull ConstraintLayout rootView,
      @NonNull CountryCodePicker ccp, @NonNull Button continueBtn, @NonNull ImageView imageView,
      @NonNull EditText phoneBox, @NonNull TextView textView, @NonNull TextView textView2) {
  ...
  public static ActivityPhoneNumberBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPhoneNumberBinding((ConstraintLayout) rootView, ccp, continueBtn,
          imageView, phoneBox, textView, textView2);
    }
