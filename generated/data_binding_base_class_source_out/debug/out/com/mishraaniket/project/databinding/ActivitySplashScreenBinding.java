...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull TextView AppName,
      @NonNull ImageView splashScreenIcon) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.splashScreenIcon;
      ImageView splashScreenIcon = ViewBindings.findChildViewById(rootView, id);
      if (splashScreenIcon == null) {
        break missingId;
      }

      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, AppName,
          splashScreenIcon);
    }
